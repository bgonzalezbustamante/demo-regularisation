...
- **Stage 2.** Run R script "**stage_2_regularisation.R**" from the code folder. This script contains the demonstration for R. Alternatively, it is possible to run "**regularisation_demo.Rmd**" and the files in "demo/regularisation_demo_files" subfolder will be overwritten.
